//! Quality and shrink-budgeting tests merged from hypothesis/{quality_discovery_ability,
//! quality_poisoned_lists, quality_poisoned_trees, quality_shrink_quality,
//! quality_zig_zagging, shrink_budgeting, nocover_collective_minimization}.
